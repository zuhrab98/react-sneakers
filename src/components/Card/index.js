...
function Card({
    ...
    const funcOnPlus = () => {
        onClickPlus({ id, image, name, price })
    }

    const funcOnFavorite = () => {
        onClickFavorit({ id, image, name, price })
    ...
    return (
        <div className={styles.card}>
            ...
            >
                ...
                <>
                    <div className={styles.favorite} onClick={funcOnFavorite}>
                    ...
                    <div className="d-flex justify-between align-center">
                        ...
                        <img className={styles.plus} onClick={funcOnPlus} src={isItemAdded(id) ? "/img/btn-checked.svg" : "/img/btn-plus.svg"} width={32} height={32} alt="plus" />
                    </div>
                </>}
        </div>
    )
